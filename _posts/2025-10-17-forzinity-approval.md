...
エラミプレチド開発の主要人物であるHazel H. Szetoは、Weill Cornellで医学生から薬理学研究者・教授としてキャリアを重ねた後、養子に迎えた娘との生活に専念するため研究を終えるつもりでした。中国から帰国した時点では、彼女自身「これで研究は一区切りだ」と確信していたそうです。彼女の初期の研究には、急性および慢性疼痛管理用に設計された新しいオピオイド化合物と、カンナビノイド化合物の薬理学が含まれていました。Szetoは2006年に、ミトコンドリア疾患をターゲットにした最初のバイオテクノロジー企業の1つであるStealth Biotherapeuticsを設立しました。
2016年、博士。SzetoはWeill Cornell Medicineを離れ、コミュニティレベルで健康的な老化を促進するための研究を支援する公共慈善団体であるSocial Profit Networkの直接研究に時間を捧げました。彼女は、身体的および感情的な健康を促進するために設計されたビタミンとサプリメントの特別な処方を開発しました。
博士兄のガイ・セトが20代前半に統合失調症と統合失調症と診断されたとき、セトはメンタルヘルスに研究を拡大しました。彼女は過去50年間、彼の主な介護者になりました。

> “We were really shocked when we found that this small peptide gets right into cells.”

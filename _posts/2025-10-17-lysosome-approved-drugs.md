...
## 概要
リソソームは、細胞内で不要物や高分子を分解・リサイクルするオルガネラです。リソソームには多数の加水分解酵素（lysosomal hydrolases）が存在し、これらの酵素遺伝子の変異や、リソソーム機能維持に関わるタンパク質の欠損は、基質（substrate）の蓄積を介して重篤な病態（lysosome-related disorders）を引き起こし得ます。
本記事では、リソソーム関連疾患に対する承認薬を、作用形式（ERT / SRT / 薬理シャペロン / 遺伝子治療）で整理し、初回承認年の時系列で俯瞰できるようにまとめます。

ERT（Enzyme Replacement Therapy；酵素補充療法）は、欠損・機能低下したリソソーム酵素を外因性に補充する治療で、末梢臓器病変に対して標準治療として確立してきました。一方で、全身投与では血液脳関門（BBB）を越えにくく、中枢神経症状（CNS manifestations）への効果が制限されやすいという構造的な制約があります。そこで近年は、基質の産生側を抑えるSRT、変異酵素のフォールディング／トラフィッキングを補助する薬理シャペロン、投与経路を工夫して中枢神経系へ直接送達するアプローチ（脳室内投与など）、さらに遺伝子導入により長期的な酵素活性の回復を狙う遺伝子治療へと、治療モダリティが拡張してきました。

...
| <strong>既存の機能指標は日差・努力依存性が大きい</strong> | <strong>6-minute walk test（6MWT）</strong>はPMM試験で広く使われていますが、日々の体調変動、意欲、併存症、非ミトコンドリア性要因の影響を受けやすく、シグナル対雑音比が低下しやすい指標です。このため、ENMCでは<strong>DHTs</strong>や<strong>PROMs</strong>を含むアウトカム設計が議論されています。[^59][^60] |

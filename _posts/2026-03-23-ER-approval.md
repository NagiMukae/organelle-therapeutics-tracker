...
代表例は<strong>嚢胞性線維症（Cystic fibrosis）</strong>と<strong>ファブリー病（Fabry disease）</strong>です。

嚢胞性線維症では、<strong>CFTR遺伝子変異（特にF508del）</strong>により、CFTRタンパク質が小胞体内で正しく折り畳めず、<strong>品質管理機構によって分解される</strong>ため、細胞膜まで到達できません。その結果、上皮細胞における<strong>Cl<sup>−</sup>輸送が低下</strong>し、水分分泌の異常を通じて<strong>粘稠な粘液の蓄積</strong>が起こります。これが慢性気道感染、気管支拡張、膵外分泌不全などの臨床症状につながります。[^10][^11]

一方、ファブリー病では、<strong>α-ガラクトシダーゼA（GLA）遺伝子変異</strong>により酵素が構造的に不安定となり、小胞体で分解されやすくなります。その結果、本来リソソームで分解されるべき<strong>グロボトリアオシルセラミド（Gb3）</strong>が蓄積し、血管内皮、腎臓、心筋、神経など多臓器に障害を引き起こします。臨床的には<strong>四肢疼痛、腎機能障害、心肥大、脳血管障害</strong>などが進行性に現れます。[^13][^14]

いずれの疾患でも本質的な問題は、<strong>機能を持ちうるタンパク質が小胞体の品質管理を通過できない</strong>点にあり、したがって<strong>折り畳みを補正して輸送を回復させる</strong>ことが治療の核になります。

### 2. 分泌負荷の高い血液系悪性腫瘍

形質細胞系腫瘍である<strong>多発性骨髄腫（multiple myeloma）</strong>は、<strong>免疫グロブリンを大量に産生する腫瘍細胞</strong>であり、小胞体の折り畳み能力とタンパク質恒常性に強く依存しています。

このような細胞では、免疫グロブリンの合成・折り畳み・分泌に伴い<strong>慢性的なERストレス状態</strong>にあり、<strong>UPRによって生存が支えられている</strong>という特徴があります。特に、誤折り畳みタンパク質はERADを介してプロテアソームに送られ、分解されることで恒常性が維持されています。[^4][^5]

<strong>プロテアソーム阻害薬</strong>（bortezomibなど）は、この<strong>分解経路の出口を遮断</strong>することで異常タンパク質を細胞内に蓄積させ、<strong>タンパク質毒性ストレスを急激に増幅</strong>します。その結果、UPRの適応能力を超え、<strong>アポトーシス誘導</strong>に至ります。臨床的には、腫瘍量の減少や症状改善につながります。[^4][^8]

このように多発性骨髄腫は、<strong>小胞体タンパク質恒常性の脆弱性そのものを治療標的とする</strong>代表的な疾患です。
